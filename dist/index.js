...
async function main() {
  ...
  console.log("\n\u2728 Project created \u2728");
  console.log(`
${import_picocolors.default.blue(`Next steps:`)}
`);
...
Check out ${import_picocolors.default.italic(
  ...
  console.log("\n---\n");
  console.log(`Questions \u{1F440}? ${import_picocolors.default.underline(import_picocolors.default.cyan("https://twitter.com/_gonzaparra"))}`);
}
